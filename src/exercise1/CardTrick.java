...
public class CardTrick {
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is Kushagar, but you can call me kush");
        System.out.println();
        
        System.out.println("My career ambitions: Game Development");
        System.out.println("-- I am not very active on social media");
        System.out.println("-- I Have a semester with no violations of academic integrity!");
	System.out.println("Would like to develop a AAA game");	
